...
enum class ECreatureKind { Unknown, Chapaa, Cearnuk, TreeClimber, MAX };

enum class ECreatureQuality { Unknown, Tier1, Tier2, Tier3, Chase, MAX };
...
enum class EBugQuality { Unknown, Common, Uncommon, Rare, Rare2, Epic, MAX };

enum class EGatherableSize { Unknown, Small, Medium, Large, Bush, MAX };

enum class ETreeType { Unknown, Flow, Heartwood, Sapwood, Bush, MAX };

enum class EOreType { Unknown, Stone, Copper, Clay, Iron, Silver, Gold, Palium, MAX };

enum class EFishType { Unknown, Node, Hook, MAX };
...
enum class EOneOffs { Player, NPC, FishHook, FishPool, Loot, Quest, RummagePiles, Stables, Others, MAX };
...
enum class ETools { None, Axe, Belt, Bow, FishingRod, Hoe, Pick, WateringCan, MAX };

inline const char *STools[] = {"None", "Axe", "Belt", "Bow", "FishingRod", "Hoe", "Pick", "WateringCan", "Unknown"};
...
class PaliaOverlay final : public OverlayBase {
    ...
    public:
        ...
        std::vector<FLocation> TeleportLocations = {// Global Home
                                                    {"UserDefined",
                                                     ELocation::Global_Home,
                                                     "[Global] Housing Plot",
                                                     {00000.000f, 00000.000f, 00000.000},
                                                     {0.000f, 0.00f, 0.000f}},
                                                    // Kilima City Spots
                                                    {"Village_Root",
                                                     ELocation::Kilima_GeneralStore,
                                                     "[Kilima] General Store",
                                                     {156.193f, -1509.144f, 305.576},
                                                     {0.000f, -122.07f, 0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_TailorStore,
                                                     "[Kilima] Tailor Store",
                                                     {-1715.341f, 2052.674f, 163.455},
                                                     {0.000f, -123.346f, 0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_FurnitureStore,
                                                     "[Kilima] Furniture Store",
                                                     {3734.435f, -563.303f, 161.163},
                                                     {0.000f, -122.006f, 0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_CityHall,
                                                     "[Kilima] City Hall",
                                                     {6344.635f, 2519.250f, 511.920},
                                                     {0.000f, 0.451f, 0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_Tavern,
                                                     "[Kilima] Tavern",
                                                     {-755.001f, 4102.823f, 330.888},
                                                     {0.000f, 120.090f, 0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_RepairStation,
                                                     "[Kilima] Repair Station",
                                                     {2465.246f, 6734.343f, 323.050},
                                                     {0.000f, 120.89f, 0.000f}},
                                                    // Kilima Entrances
                                                    {"Village_Root",
                                                     ELocation::Kilima_HousingPlot,
                                                     "[Kilima] Housing Plot Entrance",
                                                     {20204.810f, -15375.620f, 2272.460},
                                                     {0.000f, -6.24f, 0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_ToBahariBay,
                                                     "[Kilima] Bahari Bay Entrance",
                                                     {50623.753f, -5403.530f, 1332.610},
                                                     {0.000f, -24.72f, 0.000f}},
                                                    // Kilima Stables
                                                    {"Village_Root",
                                                     ELocation::Kilima_CentralStables,
                                                     "[Kilima] Central Stables",
                                                     {9746.436f, 11380.740f, -119.406},
                                                     {0.000f, 145.62f, -0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_MirrorFields,
                                                     "[Kilima] Mirror Fields",
                                                     {-6586.737f, -24412.872f, 1647.018},
                                                     {0.000f, 259.87f, 0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_LeafhopperHills,
                                                     "[Kilima] Leafhopper Hills",
                                                     {-21589.245f, 3920.281f, 326.105},
                                                     {0.000f, 117.04f, 0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_WhisperingBanks,
                                                     "[Kilima] Whispering Banks",
                                                     {38958.433f, 7574.109f, -657.983},
                                                     {0.000f, 214.71f, 0.000f}},
                                                    // Kilima Others
                                                    {"Village_Root",
                                                     ELocation::Kilima_Fairgrounds_MajiMarket,
                                                     "[Kilima] Fairgrounds Entrance (Maji Market)",
                                                     {54696.812f, 21802.943f, -94.603},
                                                     {0.000f, -7.65f, 0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_PhoenixFalls,
                                                     "[Kilima] Phoenix Falls",
                                                     {7596.145f, -51226.853f, 4026.341},
                                                     {0.000f, -68.64f, 0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_DragonShrine,
                                                     "[Kilima] Dragon Shrine",
                                                     {33743.980f, -22253.369f, 1323.870},
                                                     {0.000f, -90.211f, 0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_FishermansLagoon,
                                                     "[Kilima] Fisherman's Lagoon",
                                                     {25325.044f, 19246.651f, -439.559},
                                                     {0.000f, 25.76f, 0.000f}},
                                                    {"Village_Root",
                                                     ELocation::Kilima_WimsFishingSpot,
                                                     "[Kilima] Wims Secret Fishing Spot",
                                                     {58217.884f, 41798.154f, -432.593},
                                                     {0.000f, 94.089f, 0.000f}},
                                                    // Bahari Entrances
                                                    {"AZ1_01_Root",
                                                     ELocation::Bahari_HousingPlot,
                                                     "[Bahari] Housing Plot Entrance",
                                                     {54451.777f, -81603.203f, 962.742},
                                                     {0.000f, 2.45f, 0.000f}},
                                                    {"AZ1_01_Root",
                                                     ELocation::Bahari_ToKilimaValley,
                                                     "[Bahari] Kilima Valley Entrance",
                                                     {59457.644f, -10932.726f, 917.334},
                                                     {0.000f, -157.46f, 0.000f}},
                                                    // Bahari Stables
                                                    {"AZ1_01_Root",
                                                     ELocation::Bahari_CentralStables,
                                                     "[Bahari] Central Stables",
                                                     {103331.330f, -63125.339f, -1928.051},
                                                     {0.000f, 148.09f, -0.000f}},
                                                    {"AZ1_01_Root",
                                                     ELocation::Bahari_TheOutskirts,
                                                     "[Bahari] The Outskirts",
                                                     {55743.927f, -81821.534f, 922.205},
                                                     {0.000f, 226.06f, 0.000f}},
                                                    {"AZ1_01_Root",
                                                     ELocation::Bahari_CoralShores,
                                                     "[Bahari] Coral Shores",
                                                     {143344.052f, -71851.374f, -4353.302},
                                                     {0.000f, 352.16f, 0.000f}},
                                                    {"AZ1_01_Root",
                                                     ELocation::Bahari_PulsewaterPlains,
                                                     "[Bahari] Pulsewater Plains",
                                                     {101257.267f, -23873.064f, -1635.604},
                                                     {0.000f, 287.12f, 0.000f}},
                                                    {"AZ1_01_Root",
                                                     ELocation::Bahari_HideawayBluffs,
                                                     "[Bahari] Hideaway Bluffs",
                                                     {82490.721f, 2994.478f, -694.785},
                                                     {0.000f, 14.61f, 0.000f}},
                                                    {"AZ1_01_Root",
                                                     ELocation::Bahari_BeachcomberCove,
                                                     "[Bahari] Beachcomber Cove",
                                                     {128767.154f, 4163.842f, -4386.759},
                                                     {0.000f, 312.00f, 0.000f}}};
        ...
        std::map<EOreType, std::vector<std::string>> MINING_TYPE_MAPPINGS = {
            {EOreType::Stone, {"_Stone_"}},  {EOreType::Copper, {"_Copper_"}}, {EOreType::Clay, {"_Clay_"}},
            {EOreType::Iron, {"_Iron_"}},    {EOreType::Silver, {"_Silver_"}}, {EOreType::Gold, {"_Gold_"}},
        ...
        unsigned int SingleColors[static_cast<int>(EOneOffs::MAX)] = {
            IM_COL32(0xFF, 0xFF, 0x00, 0xFF), IM_COL32(0xFF, 0xFF, 0xFF, 0xFF), IM_COL32(0xFF, 0xFF, 0xFF, 0xFF),
            IM_COL32(0xFF, 0xFF, 0xFF, 0xFF), IM_COL32(0x00, 0xFF, 0xFF, 0xFF), IM_COL32(0xFF, 0xFF, 0xFF, 0xFF),
        };
        ...
        int ForageableCommon[4] = {static_cast<int>(EForageableType::Oyster), static_cast<int>(EForageableType::Shell),
                                   static_cast<int>(EForageableType::Sundrop),
                                   static_cast<int>(EForageableType::MushroomRed)};

        int ForageableUncommon[9] = {
            static_cast<int>(EForageableType::Coral),         static_cast<int>(EForageableType::PoisonFlower),
            static_cast<int>(EForageableType::WaterFlower),   static_cast<int>(EForageableType::EmeraldCarpet),
            static_cast<int>(EForageableType::SpicedSprouts), static_cast<int>(EForageableType::SweetLeaves),
            static_cast<int>(EForageableType::Garlic),        static_cast<int>(EForageableType::Ginger),
            static_cast<int>(EForageableType::GreenOnion)};

        int ForageableRare[3] = {static_cast<int>(EForageableType::DragonsBeard),
                                 static_cast<int>(EForageableType::MushroomBlue),
                                 static_cast<int>(EForageableType::HeatRoot)};

        int ForageableEpic[2] = {static_cast<int>(EForageableType::Heartdrop),
        ...
        unsigned int OreColors[static_cast<int>(EOreType::MAX)] = {
            IM_COL32(0xFF, 0xFF, 0xFF, 0xFF), IM_COL32(0x88, 0x8C, 0x8D, 0xFF), // Stone
        ...
        unsigned int TreeColors[static_cast<int>(ETreeType::MAX)] = {
            IM_COL32(0xFF, 0xFF, 0xFF, 0xFF), IM_COL32(0x67, 0x00, 0xEA, 0xFF), IM_COL32(0x00, 0xFF, 0x00, 0xFF),
            IM_COL32(0x00, 0xFF, 0x00, 0xFF), IM_COL32(0xFF, 0xFF, 0xFF, 0xFF),
        };
        ...
        const char *bFishingSpots[14] = {"- none -",       "River Village", "River Village *", "Pond Village",
                                         "Pond Village *", "Lake Village",  "Lake Village *",  "Ocean AZ1",
                                         "Ocean AZ1 *",    "River AZ1",     "River AZ1 *",     "Cave AZ1",
                                         "Cave AZ1 *",     "100G Pool"};
        const FString bFishingSpotsFString[13]{L"RiverVillage", L"RiverVillage_SQ", L"PondVillage", L"PondVillage_SQ",
                                               L"LakeVillage",  L"LakeVillage_SQ",  L"OceanAZ1",    L"OceanAZ1_SQ",
                                               L"RiverAZ1",     L"RiverAZ1_SQ",     L"CaveAZ1",     L"CaveAZ1_SQ",
                                               L"test"};
};
