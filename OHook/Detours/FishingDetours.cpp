...
void FishingDetours::Func_DoFastAutoFishing() {
...
void FishingDetours::Func_DoFishingCaptureOverride(void* Params) {
...
Params::FishingComponent_RpcServer_EndFishing* FishingDetours::EndFishingDetoured(void* Params) {
