...
public:
    ...
    double Despawn;
    bool ShouldShow(const SDK::AValeriaCharacter*) const;
};
...
static inline std::vector<std::string> ECreatureKindString = {
    "Unknown",
    "Chapaa",
    "Sernuk",
    "Muujin",
...
static inline std::vector<std::string> ECreatureQualityString = {
    "Unknown",
    "Tier1",
    "Tier2",
    "Tier3",
...
static inline std::vector<std::string> EBugKindString = {
    "Unknown",
    "Bee",
    "Beetle",
    "Butterfly",
...
static inline std::vector<std::string> EBugQualityString = {
    "Unknown",
    "Common",
    "Uncommon",
    "Rare",
...
static inline std::vector<std::string> EGatherableSizeString = {
    "Unknown",
    "Sapling",
    "Small",
    "Medium",
...
static inline std::vector<std::string> ETreeTypeString = {
    "Unknown",
    "Flow",
    "Heartwood",
    "Sapwood",
...
static inline std::vector<std::string> EOreTypeString = {
    "Unknown",
    "Stone",
    "Copper",
    "Clay",
...
static inline std::vector<std::string> EForageableTypeString = {
    "Unknown",
    "Oyster",
    "Coral",
    "Mushroom Blue",
...
inline std::map<EGatherableSize, std::vector<std::string>> GATHERABLE_SIZE_MAPPINGS = {
    {EGatherableSize::Small, {"_Small_"}},
    {EGatherableSize::Medium, {"_Medium_"}},
    {EGatherableSize::Large, {"_Large_", "_Large2_"}},
    {EGatherableSize::Sapling, {"_Bush_", "_Sapling_"}},
};
...
inline std::map<ETreeType, std::vector<std::string>> TREE_TYPE_MAPPINGS = {
    ...
    {ETreeType::Sapwood, {"_Juniper_", "_Oak_", "_Birch_", "_TreeBirch_", "_TreeOak_"}},
...
inline std::map<EOreType, std::vector<std::string>> MINING_TYPE_MAPPINGS = {
    {EOreType::Stone, {"_Stone_", "_RockL_"}},
