...
namespace ImGui {
    namespace Spectrum {
        ...
        const unsigned int BLUE50 = Color(0x81BFEE);
        const unsigned int BLUE100 = Color(0x7BBAEA);
        const unsigned int BLUE200 = Color(0x51A9E5);
        const unsigned int BLUE300 = Color(0x469DE0);
