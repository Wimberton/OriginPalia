...
namespace ImGui {
    namespace Magma {
        ...
        namespace Static { // static colors
            ...
            const unsigned int RED100 = Color(0xCF343B);
            const unsigned int RED200 = Color(0xD83D44);
            const unsigned int RED300 = Color(0xE1484F);
        ...
        const unsigned int GRAY900 = Color(0xF7F7F7);
        ...
        const unsigned int RED50 = Color(0x9C262B);
        const unsigned int RED75 = Color(0xA9292F);
        const unsigned int RED100 = Color(0xCF343B);
        const unsigned int RED200 = Color(0xD83D44);
        const unsigned int RED300 = Color(0xE1484F);
